...
function render() {
	...
	for ( var i = 0, il = particles.length; i < il; i ++ ) {
		...
		particle.z = particle.z < 0.2 ? 30 : particle.z - 0.005;

		var ow = 10 / particle.z;
		...
		particle.domElement.style['-ms-transform'] = 'scale( ' + ow + ' )';
		particle.domElement.style['transform'] = 'scale( ' + ow + ' )';
